...
capacity degradation". We are building models, in the "notebooks" folder. First, I have created two linear regression models to predict cycle life (called 1-Cycle-life-prediction-using-interpretable-ML.ipynb), and I'm currently constructing a classifier to sort into high and low cycle life categories, but it has not been posted yet. 
