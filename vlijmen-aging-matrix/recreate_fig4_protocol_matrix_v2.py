...
# Colormap for the single-row EFC bar (mimics Fig. 3 styling)
...
OUT_FIG = r"fig4_protocol_matrix_v2.png"
OUT_TABLE = r"fig4_protocol_matrix_values_v2.csv"
OUT_EFC_BAR = r"fig3_efc_bar_from_fig4_cohort_v2.png"
...
efc_vals = mean_abs_shap_norm_matrix[efc_row_i, :]          # row-normalized feature importance
efc_rae = rae_arr[efc_row_i]                                # matching RAE
